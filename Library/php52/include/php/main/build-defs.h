...
#define CONFIGURE_COMMAND " './configure'  '--prefix=/Applications/MNPP/Library/php52' '--exec-prefix=/Applications/MNPP/Library/php52' '--enable-cli' '--enable-gd-jis-conv' '--enable-gd-native-ttf' '--enable-mbstring' '--with-bz2' '--with-curl=/Applications/MNPP/Library/curl' '--with-gd=/Applications/MNPP/Library/gd' '--with-gettext=shared,/Applications/MNPP/Library/gettext' '--with-freetype-dir=/Applications/MNPP/Library/freetype' '--with-jpeg-dir=/Applications/MNPP/Library/jpeg' '--with-libxml-dir=/Applications/MNPP/Library/libxml' '--with-xsl=/Applications/MNPP/Library/libxslt' '--with-mcrypt=shared,/Applications/MNPP/Library/mcrypt' '--with-mhash' '--with-mysql=/Applications/MNPP/Library/mysql' '--with-pdo-mysql=/Applications/MNPP/Library/mysql/bin/mysql_config' '--enable-sockets' '--with-mysqli=/Applications/MNPP/Library/mysql/bin/mysql_config' '--with-openssl' '--with-png-dir=/Applications/MNPP/Library/libpng' '--with-readline' '--with-ttf' '--with-xpm-dir=/Applications/MNPP/Library/xpm' '--with-zlib' '--with-config-file-path=/Applications/MNPP/conf/php52' '--enable-fastcgi' '--enable-fpm' '--enable-force-cgi-redirect' '--with-fpm-conf=/Applications/MNPP/conf/php52/php-fpm' '--with-fpm-log=/Applications/MNPP/logs/php52/php-fpm.log' '--with-fpm-pid=/Applications/MNPP/tmp/php52/php-fpm.pid' '--with-libedit' '--enable-libxml' '--enable-dom' '--with-ncurses=/usr/lib' '--enable-pdo' '--disable-all'"
